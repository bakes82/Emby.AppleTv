...
using AppleTv.Api.DataContracts.Users.Collection;
using AppleTv.Api.DataContracts.Users.Playback;
using AppleTv.Api.DataContracts.Users.Watched;
using MediaBrowser.Controller.Entities;
using MediaBrowser.Controller.Entities.TV;
using MediaBrowser.Model.Entities;

namespace AppleTv.Helpers
{
    class Match
    {
